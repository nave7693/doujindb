...
public final class Theme extends DefaultMetalTheme
{
	...
	public Theme(Color color1, Color color2, Font font)
	{
		...
		sec1 = new ColorUIResource(new ColorUIResource(75,75,75));
		sec2 = new ColorUIResource(new ColorUIResource(100,100,100));
		sec3 = new ColorUIResource(new ColorUIResource(45,45,45));
		win1 = new ColorUIResource(new ColorUIResource((int)(r1/1.1),(int)(g1/1.1),(int)(b1/1.1)));
		win2 = new ColorUIResource(new ColorUIResource(64,64,64));
		win3 = new ColorUIResource(new ColorUIResource(64,64,64));
		...
		win6 = new ColorUIResource(new ColorUIResource(64,64,64));
		...
		win10 = new ColorUIResource(new ColorUIResource(64,64,64));
		win11 = new ColorUIResource(new ColorUIResource(0,0,0));
		win12 = new ColorUIResource(new ColorUIResource(64,64,64));*/
		prim1 = new ColorUIResource(new ColorUIResource(0,0,0));
		prim2 = new ColorUIResource(new ColorUIResource((int)(r1/1.1),(int)(g1/1.1),(int)(b1/1.1)));
		prim3 = new ColorUIResource(new ColorUIResource((int)(r1/1.2),(int)(g1/1.2),(int)(b1/1.2)));
		...
		/*controlFont = new FontUIResource("Verdana",0,11);
		captionFont = new FontUIResource("Verdana",0,11);
		systemFont = new FontUIResource("Verdana",0,11);
		userFont = new FontUIResource("Verdana",0,11);
		smallFont = new FontUIResource("Verdana",0,11);*/
