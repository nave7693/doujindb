...
{
	public static final ConfigurationItem<String> options_http_useragent = new ConfigurationItem<String>("Mozilla/5.0 (compatible; " + DataImport.Name+ "/" + DataImport.Version + "; +" + DataImport.Weblink + ")", "User-Agent used in HTTP requests");
	...
	public static final ConfigurationItem<Boolean> provider_mugimugi_autoresize = new ConfigurationItem<Boolean>(true , "Resize covers automatically before upload");
}
