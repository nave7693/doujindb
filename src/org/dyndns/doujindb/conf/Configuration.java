...
//		configAdd("org.dyndns.doujindb.plugin.timeout",               "<html><body>Timeout (in seconds) which PluginManager will wait for plugins to start/stop.</body></html>", 60);
		...
		configAdd("org.dyndns.doujindb.log.org.dyndns.doujindb.plug", "<html><body>Log LEVEL for doujindb plugins.</body></html>", "info");
		configAdd("org.dyndns.doujindb.log.org.dyndns.doujindb.ui",   "<html><body>Log LEVEL for doujindb user interface.</body></html>", "info");
