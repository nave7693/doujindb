...
public abstract class _Circle extends CayenneDataObject {
    ...
    public void addToAliases(CircleAlias obj) {
        addToManyTarget("aliases", obj, true);
    }
    public void removeFromAliases(CircleAlias obj) {
        removeToManyTarget("aliases", obj, true);
    }
    @SuppressWarnings("unchecked")
    public Set<CircleAlias> getAliases() {
        return (Set<CircleAlias>)readProperty("aliases");
    }
